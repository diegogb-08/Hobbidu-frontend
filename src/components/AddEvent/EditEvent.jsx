...
const EditEvent = (props) => {
  ...
  const selectHobby = (hobbyId) => {
    ...
    setEvent({ ...event, hobbyId: hobbyId });
    setMessage("");
  };
            ...
            <div className="addEventSections">
              <div className="inputEvent smallInputs">
                <div>
                  ...
                  <select
                    ...
                    name="maxJoiners"
                    onChange={handleChange}
                    defaultValue={editEvent.maxJoiners}
                  >
                ...
                <div>
                  ...
                  <label className="switch">
                    <input
                      ...
                      defaultChecked={editEvent.vehicle}
                    />
              ...
              <div className="inputEvent">
                ...
                <input
                  ...
                  name="joiners"
                  maxLength="20"
                  onChange={handleJoiners}
                  placeholder="Add yourself and your friends"
                />
              ...
              <div className="inputEvent">
                ...
                <p>
                  Try to give as much information as you can so the joiners can
                  get full info!
                </p>
                <textarea
                  className="text"
